                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="stastics.php"><i class="menu-icon icon-tasks"></i>Stastics <b class="label orange pull-right">
                                    </b> </a></li>
                            </ul>
                            <!--/.widget-nav-->
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="forminput.php" method="POST">
										<div class="control-group">
											<label class="control-label" for="inputname">Name</label>
											<div class="controls">
												<input type="text" id="inputname" placeholder="Type your Name" class="span8" name='name'>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input  type="email" id="inputemail" placeholder="Enter your Email" data-original-title="" class="span8 tip" name='email'>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="inputage" placeholder="Enter age" class="span8" name='age'>
											</div>
										</div>
										<div class="control-group">
										...
										<div class="control-group">
											<label class="control-label" for="password1">OTP</label>
											<div class="controls">
												<input type="password" id="password1" class="span8" name='pass'>
											</div>
										</div>
