						...
						<div class="module">
							<div class="module-body">
                                ...
                                <div class="progress progress-info">
                                    <div class="bar" style="width: 80%"><b>Percentage Increase in login</b></div>
                                  </div>
                                  <div class="progress progress-success">
                                    <div class="bar" style="width: 40%"><b>Users active</b></div>
                                  </div>
                                  <div class="progress progress-warning">
                                    <div class="bar" style="width: 60%"><b>Users Inactive</b></div>
                                  </div>
                                  <div class="progress progress-danger">
                                    <div class="bar" style="width: 20%"><b>Account Deleted</b></div>
                                  </div>
                            </div>
						</div>
