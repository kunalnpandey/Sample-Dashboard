					...
					<div class="content">
						...
						<div class="module">
							<div class="module-body">
									...
									<form class="form-horizontal row-fluid" action="delete.php" method="POST">

										<div class="control-group">
											<label class="control-label" for="basicinput">Name</label>
											<div class="controls">
												<input  type="text" placeholder="Enter Name" data-original-title="" class="span8 tip" name="name">
											</div>
										</div>
